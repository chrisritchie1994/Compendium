!function (e, t) {
    ...
    "use strict";
    var e, t, n, a = 'Roboto, "Liberation Mono", Menlo, Courier, monospace', //"SFMono-Regular",
        r = "\n  .codeflask {\n    position: absolute;\n    width: 100%;\n    height: 100%;\n    overflow: hidden;\n  }\n\n  .codeflask, .codeflask * {\n    box-sizing: border-box;\n  }\n\n  .codeflask__pre {\n    pointer-events: none;\n    z-index: 3;\n    overflow: hidden;\n  }\n\n  .codeflask__textarea {\n    background: none;\n    border: none;\n    color: " + (e = "caret-color", t = "#000", (CSS ? CSS.supports(e, t) : (n = (n = e).split("-").filter(function (e) {
            return !!e
        }).map(function (e) {
    ...
    function i(e, t, n) {
        var a = t || "codeflask-style", r = n || document.head;
        if (!e) return !1;
        if (document.getElementById(a)) return !0;
        var i = document.createElement("style");
        return i.innerHTML = e, i.id = a, r.appendChild(i), !0
    }
    ...
    var c, u = (function (e) {
        var t = "undefined" != typeof window ? window : "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope ? self : {},
            n = function () {
                var e = /\blang(?:uage)?-([\w-]+)\b/i, n = 0, a = t.Prism = {
                    ...
                    highlightElement: function (n, r, i) {
                        ...
                        l && (o = (l.className.match(e) || [, ""])[1].toLowerCase(), s = a.languages[o]), n.className = n.className.replace(e, "").replace(/\s+/g, " ") + " language-" + o, n.parentNode && (l = n.parentNode, /pre/i.test(l.nodeName) && (l.className = l.className.replace(e, "").replace(/\s+/g, " ") + " language-" + o));
                        ...
                        if (a.hooks.run("before-highlight", c), r && t.Worker) {
                            var u = new Worker(a.filename);
                            u.onmessage = function (e) {
                                c.highlightedCode = e.data, a.hooks.run("before-insert", c), c.element.innerHTML = c.highlightedCode, i && i.call(c.element), a.hooks.run("after-highlight", c), a.hooks.run("complete", c)
                            }, u.postMessage(JSON.stringify({language: c.language, code: c.code, immediateClose: !0}))
                        } else c.highlightedCode = a.highlight(c.code, c.grammar, c.language), a.hooks.run("before-insert", c), c.element.innerHTML = c.highlightedCode, i && i.call(n), a.hooks.run("after-highlight", c), a.hooks.run("complete", c)
                    },
                    ...
                    matchGrammar: function (e, t, n, r, i, o, s) {
                        ...
                        for (var c in n) if (n.hasOwnProperty(c) && n[c]) {
                            ...
                            for (var d = 0; d < u.length; ++d) {
                                var p = u[d], h = p.inside, g = !!p.lookbehind, f = !!p.greedy, m = 0, b = p.alias;
                                if (f && !p.pattern.global) {
                                    var y = p.pattern.toString().match(/[imuy]*$/)[0];
                                    p.pattern = RegExp(p.pattern.source, y + "g")
                                }
                                p = p.pattern || p;
                                for (var k = r, x = i; k < t.length; x += t[k].length, ++k) {
                                    var v = t[k];
                                    if (t.length > e.length) return;
                                    if (!(v instanceof l)) {
                                        if (f && k != t.length - 1) {
                                            if (p.lastIndex = x, !(S = p.exec(e))) break;
                                            for (var w = S.index + (g ? S[1].length : 0), C = S.index + S[0].length, T = k, F = x, A = t.length; T < A && (F < C || !t[T].type && !t[T - 1].greedy); ++T) w >= (F += t[T].length) && (++k, x = F);
                                            if (t[k] instanceof l) continue;
                                            L = T - k, v = e.slice(x, F), S.index -= x
                                        } else {
                                            p.lastIndex = 0;
                                            var S = p.exec(v), L = 1
                                        }
                                        if (S) {
                                            g && (m = S[1] ? S[1].length : 0);
                                            C = (w = S.index + m) + (S = S[0].slice(m)).length;
                                            var _ = v.slice(0, w), E = v.slice(C), N = [k, L];
                                            _ && (++k, x += _.length, N.push(_));
                                            var j = new l(c, h ? a.tokenize(S, h) : S, b, S, f);
                                            if (N.push(j), E && N.push(E), Array.prototype.splice.apply(t, N), 1 != L && a.matchGrammar(e, t, n, k, x, !0, c), o) break
                                        } else if (o) break
                                    }
                                }
                            }
                ...
                if (r.stringify = function (e, t, n) {
                    ...
                    var n = JSON.parse(e.data), r = n.language, i = n.code, o = n.immediateClose;
                    t.postMessage(a.highlight(i, a.languages[r], r)), o && t.close()
                }, !1), t.Prism) : t.Prism;
                var i = document.currentScript || [].slice.call(document.getElementsByTagName("script")).pop();
                return i && (a.filename = i.src, a.manual || i.hasAttribute("data-manual") || ("loading" !== document.readyState ? window.requestAnimationFrame ? window.requestAnimationFrame(a.highlightAll) : window.setTimeout(a.highlightAll, 16) : document.addEventListener("DOMContentLoaded", a.highlightAll))), t.Prism
            }();
        e.exports && (e.exports = n), void 0 !== l && (l.Prism = n), n.languages.markup = {
            ...
            n.languages.compendium= {principle: /#p([\S\s]*?)p#/g, idea: /#i([\S\s]*?)i#/g, decision: /#d([\S\s]*?)d#/g, aphorism: /#a([\S\s]*?)a#/g, observation: /#o([\S\s]*?)o#/g},
            ...
            Array.prototype.slice.call(document.querySelectorAll("pre[data-src]")).forEach(function (t) {
                for (var a, r = t.getAttribute("data-src"), i = t, o = /\blang(?:uage)?-([\w-]+)\b/i; i && !o.test(i.className);) i = i.parentNode;
                if (i && (a = (t.className.match(o) || [, ""])[1]), !a) {
                    var s = (r.match(/\.(\w+)$/) || [, ""])[1];
                    a = e[s] || s
                }
    ...
    }(c = {exports: {}}, c.exports), c.exports), d = function (e, t) {
    ...
    return d.prototype.startEditor = function () {
        if (!i(r, null, this.opts.styleParent)) throw Error("Failed to inject CodeFlask CSS.");
        ...
        this.elTextarea.addEventListener("input", function (t) {
            e.code = t.target.value, e.elCode.innerHTML = s(t.target.value), e.highlight(), setTimeout(function () {
        ...
        if (this.opts.handleTabs) {
            ...
            var t = this.elTextarea.selectionStart, n = this.elTextarea.selectionEnd,
                a = "" + this.code.substring(0, t) + " ".repeat(this.opts.tabSize) + this.code.substring(n);
            this.updateCode(a), this.elTextarea.selectionEnd = n + this.opts.tabSize
        }
    }, d.prototype.handleSelfClosingCharacters = function (e) {
        var t = e.key;
        if (["(", "[", "{", "<", "#"].includes(t)) switch (t) {
            case"(":
                this.closeCharacter(")");
                break;
            case"[":
        ...
        var t = this.elTextarea.selectionStart, n = this.elTextarea.selectionEnd,
            a = "" + this.code.substring(0, t) + e + this.code.substring(n);
        this.updateCode(a), this.elTextarea.selectionEnd = n
    }, d.prototype.updateCode = function (e) {
        this.code = e, this.elTextarea.value = e, this.elCode.innerHTML = s(e), this.highlight(), this.setLineNumber(), setTimeout(this.runUpdate.bind(this), 1)
